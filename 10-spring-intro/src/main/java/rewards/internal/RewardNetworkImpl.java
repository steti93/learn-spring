...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		...
		Account beneficiaryAccount = accountRepository.findByCreditCard(dining.getCreditCardNumber());
		Restaurant byMerchantNumber = restaurantRepository.findByMerchantNumber(dining.getMerchantNumber());
		MonetaryAmount monetaryAmount = byMerchantNumber.calculateBenefitFor(beneficiaryAccount, dining);
		AccountContribution accountContribution = beneficiaryAccount.makeContribution(monetaryAmount);
		accountRepository.updateBeneficiaries(beneficiaryAccount);
